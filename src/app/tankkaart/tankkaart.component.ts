                ...
                this.tankkaartService.updateTankkaart(tankkaart)
                    .subscribe(newTankkaart => {
                        if (typeof(newTankkaart) == 'undefined') {
                            ...
                            this.bestuurderService.clearTankkaart(this.bestuurders, newTankkaart.id);
                            if (newTankkaart.tanBestuurder !== 0) {
                                this.bestuurderService.setTankkaart(newTankkaart.tanBestuurder, newTankkaart.id);
                            }
                ...
                this.tankkaartService.createTankkaart(tankkaart)
                    .subscribe(newTankkaart => {
                        if (typeof(newTankkaart) == 'undefined') {
                            ...
                            console.log("Gegevens voor tankkaart #"+newTankkaart.id+" werden succesvol opgeslagen!");
                            this.bestuurderService.setTankkaart(newTankkaart.tanBestuurder, newTankkaart.id);
                            this.tankkaartService.getTankkaarten()
                                .subscribe(tankkaarten => {
                                    this.tankkaarten = tankkaarten;
